...
## UI / UX Design System: Apple.com Aesthetic

All frontend pages, components, and layouts in this project MUST strictly follow the **Apple.com design language**:

### 1. Typography & Hierarchy
- **Font Stack**: System fonts prioritizing San Francisco (`-apple-system, BlinkMacSystemFont, "SF Pro Text", "SF Pro Display", "Segoe UI", Roboto, sans-serif`).
...
- **Content & Bento Sections**: Apple off-white/light gray (`#f5f5f7`) with pure white cards (`#ffffff`) and soft shadows (`shadow-sm`).
- **Primary Accent / Interactive**: Apple Blue (`#0066cc`, hover `#0071e3`).
...
- **Grids & Cards**: Bento-box layouts with generous border radii (`rounded-[2rem]` or `rounded-[2.5rem]`).
